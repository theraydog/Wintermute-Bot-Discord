...
var hiWords = ['hi ', 'hello ', 'hey ', 'howdy ', 'heya ', 'hiya ', 'yo ', 'hi,', 'hello,', 'hey,', 'howdy,', 'heya,', 'hiya,', 'yo,', 'hola,', 'hola '];
...
bot.on('message', message => {
  ...
  console.log("log |" + chalk.bgGreen.black(' '+message.createdAt+' ') + '|  ' + chalk.white(message.author.username + "  :  " + msg));
...
bot.login(cfg.token).then(() => {
  console.log("\nIt's all wavy gravy over here baby!\n");
});
