module.exports = {
  ...
  // i.e: "-wintermute foo" will trigger the command "foo",
  //      whereas "Wintermute foo" will do nothing at all.
  prefix:  "-wintermute",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjc3MTI2NzgyMDkwNjA4NjQx.C3ZOJw._xlDRjUQFj_yrCeaVUvadQ0SOlU",
